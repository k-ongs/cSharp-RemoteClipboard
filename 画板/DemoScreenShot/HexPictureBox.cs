...
namespace DemoScreenShot
{
    ...
    public partial class HexPictureBox : PictureBox
    {
        ...
        public void SetPen(Color c)
        {
            ...
            //通过图片的句柄获取指针
            this.Cursor = new Cursor(global::DemoScreenShot.Properties.Resources.pen.GetHicon());
            this.StartDraw = true;
        }
        ...
        public void SetLightPen()
        {
            ...
            this.DrawTypes = DrawType.Line;
            this.Cursor = new Cursor(global::DemoScreenShot.Properties.Resources.lightpen.GetHicon());
        ...
        public void SetEarser() {
            ...
            this.Cursor = new Cursor(global::DemoScreenShot.Properties.Resources.easer1.GetHicon());
        }
