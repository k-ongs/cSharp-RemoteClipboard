...
{
    public partial class FormUnBindQQ : Form
    {
        #region 绘制窗体阴影
        ...
        private void FormUnBindQQ_Load(object sender, EventArgs e)
        {
        ...
        private void timerQrcode_Tick(object sender, EventArgs e)
        {
            if (ClassStatic.tcpClient.IsConnected)
            {
                ...
                ClassStatic.tcpClient.Send(206, new byte[] { }, action, 1500);
            }
            else
            {
